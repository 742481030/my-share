...
downloadres(){
  cd ~/Downloads
curl -sSO https://new.cy/https://github.com/742481030/my-share/raw/master/fuse.pkg && echo "下载fuse成功"
...
curl -sSO https://new.cy/https://github.com/742481030/my-share/raw/master/rclone.conf && echo "下载配置文件成功"
ls
